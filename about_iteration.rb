...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #1*2=2, 2*3=6 and 6*4=24 (accumulates) 
    #1 and 0 passed as arguments work as the start of the accumulator
  ...
  # Bc it is closed automatically once you're done doing whatever you need to do between the block
