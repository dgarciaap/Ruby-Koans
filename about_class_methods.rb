...
class AboutClassMethods < Neo::Koan
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods
    ...
    rover = Dog.new
    def fido.wag
      :fidos_wag #Singleton method(only available for that single object)
    end
  ...
  def test_heres_an_easy_way_to_call_class_methods_from_instance_methods
    ...
    #It would be different if we'd called 'fido.another_class_method' (we wouldn't have access to it)
  end
